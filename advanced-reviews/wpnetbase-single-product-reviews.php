...
<div id="reviews_summary">
    <h3><?php _e('Customers\' review', 'wpnetbase') ?></h3>
    ...
    <div class="reviews_bar">
        ...
        <?php for ($i = 5; $i >= 1; $i--) :
            ...
            <div class="wpnetbase_review_row">
                <span class="wpnetbase_stars_value"><?php printf(_n('%s star', '%s stars', $i, 'wpnetbase'), $i); ?></span>
				...
				<span class="wpnetbase_rating_bar">
					<span style="background-color:#f4f4f4" class="wpnetbase_scala_rating">
						<span class="wpnetbase_perc_rating" style="<?php echo 'width:'.$perc.'% ;'; ?> background-color:#25bce9">							
